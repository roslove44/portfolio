...
<BlogImage
  ...
  alt="Le serveur de prévisualisation de BrandArtisan affichant un template rendu en PNG"
  caption="npm run dev : chaque template est rendu et rechargé à la sauvegarde."
/>
