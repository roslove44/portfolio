...
<BlogImage src="/blog/brand-artisan-jsx-to-png/preview-view.webp" alt="The BrandArtisan preview server showing a template rendered as PNG" caption="npm run dev: every template is rendered and reloaded on save." />
